...
function Barmens (name, age, coctail) {
...
Barmens.prototype = Object.create(Person.prototype);
Waiters.prototype = Object.create(Person.prototype);

Barmens.prototype.constructor = Barmens;
Waiters.prototype.constructor = Waiters;

Bar.prototype.addEmployee = function(person) {
...
Bar.prototype.fireEmployee = function(person){
	switch(person.position){
...
Bar.prototype.resupplyProducts = function(nameDrink, count) {
	var newDrink = {
		nameDrink,
		count
	};
...
Waiters.prototype.takeOrder = function(nameDrink, count, barName) {
	let newOrder = {
		nameDrink,
		count
	} 
...
Waiters.prototype.executeOrder = function(nameDrink, count, barName){
...
Waiters.prototype.addTips = function(num, barName) {
	barName.tips += num;	
	return barName.tips;
}

Bar.prototype.shareTips = function() {
...
const sam = new Waiters("Sam", 21);
const emma  = new Waiters("Emma", 24);
const sophia  = new Waiters("Sophia", 23);
const daniel = new Barmens ("Daniel", 19);
const sergey = new Barmens ("Sergey", 30);
const vitaliy = new Barmens ("Vitaliy", 25);
